          ...
          {registered ? (
            <div>
              ...
              <p className="mb-6 text-[13px] text-white/30">
                We sent a verification email to <span className="text-white/50">{email}</span>. Check your inbox.
              </p>
              <button
                onClick={() => {
                  const raw = searchParams.get("redirect")
                ...
                className="w-full rounded-lg bg-[#D4A853] px-4 py-3 text-[13px] font-medium text-[#0E0D0C] transition-colors hover:bg-[#E8C778]"
              >
                Continue to app
              </button>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                ...
                {!isRegister && (
                  <Link
                    ...
                    className="self-end text-[11px] text-white/25 hover:text-white/40 transition-colors"
                  >
                    Forgot password?
                  </Link>
                )}
