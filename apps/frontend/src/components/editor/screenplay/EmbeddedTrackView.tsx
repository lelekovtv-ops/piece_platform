            ...
            onMouseDown={(e) => {
              ...
              document.addEventListener("mouseup", (ev) => {
                ...
                const applyDuration = (blockId: string, ms: number) => {
                  useScriptStore.getState().updateBlockProduction(blockId, { durationMs: ms, durationSource: "manual" }, "timeline")
                  const entries = useRundownStore.getState().entries
                  const entry = entries.find((e) => e.parentBlockId === blockId)
                  if (entry) useRundownStore.getState().setManualDuration(entry.id, ms)
                }
