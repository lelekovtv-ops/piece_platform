...
const { signImagorUrl, thumbnailUrl, previewUrl, videoThumbnailUrl } =
  await import("../imagor.js");

describe("imagor", () => {
  describe("signImagorUrl", () => {
    it("should produce a valid HMAC-SHA256 signed URL", () => {
      const path =
        "fill/200x200/filters:quality(60)/piece-uploads/team1/uploads/photo.jpg";
