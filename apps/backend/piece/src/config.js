...
const ServiceSchema = BaseConfigSchema.merge(DatabaseConfigSchema)
  ...
  .extend({
    ...
    S3_BUCKET: z.string().default("piece-uploads"),
    ...
    S3_FORCE_PATH_STYLE: z
      ...
      .default("true"),
    S3_PUBLIC_URL: z.string().default("http://localhost:9006/piece-uploads"),
