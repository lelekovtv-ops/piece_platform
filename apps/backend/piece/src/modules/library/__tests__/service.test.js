  ...
  describe('createFile', () => {
    it('should create a library file record', async () => {
      ...
      const result = await libraryService.createFile('team-1', {
        ...
        publicUrl: '/storage/koza-uploads/team-1/proj-1/uploads/123_photo.jpg',
        tags: ['portrait'],
        origin: 'uploaded',
        createdBy: 'user-1',
      });
    ...
    it('should auto-generate imagor thumbnail URLs for images', async () => {
      ...
      await libraryService.createFile('team-1', {
        ...
        size: 5000,
        s3Key: 'key/test.png',
        publicUrl: '/storage/koza-uploads/key/test.png',
        tags: [],
        origin: 'uploaded',
        createdBy: 'user-1',
      });
    ...
    it('should use video thumbnail URL for video files', async () => {
      ...
      await libraryService.createFile('team-1', {
        ...
        size: 50000,
        s3Key: 'key/clip.mp4',
        publicUrl: '/storage/koza-uploads/key/clip.mp4',
        tags: [],
        origin: 'uploaded',
        createdBy: 'user-1',
      });
