...
> **piece** = cinematic AI platform + enterprise multi-user backend.
> Frontend: Next.js 16 + React 19 + TypeScript + Tailwind v4.
> Backend: Express.js + MongoDB + @piece/\* packages.
...
This is an exception to the JS-only rule — the frontend uses TypeScript.
...
This is a cinematic AI production platform.
